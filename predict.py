...
def get_predict(model_path = 'technical_model.h5', symbol = 'GOOGL', update = 'daily'):
    stock = './data/' + symbol.upper() + "_" + update.lower() + ".csv"
    print(stock)
    print(model_path)
    model = load_model(model_path)

    ohlcv_histories, technical_indicators, next_day_open_values, unscaled_y, y_normaliser = csv_to_dataset(stock)
